insert into Teacher values (1, 'Jan', 'Kowalski');
insert into Teacher values (2, 'Adam', 'Nowak');
insert into Teacher values (3, 'Tomasz', 'Kasprzyk');
insert into Teacher values (4, 'Mateusz', 'Mewa');
insert into Teacher values (5, 'Ilona', 'Ziaja');

insert into Student values ('96110411995', 'B³a¿ej', 'Jokin');
